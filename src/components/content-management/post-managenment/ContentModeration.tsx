...
const ContentModeration:React.FC<Props> = ({ onClose }) => {
  ...
  const defaultPrompt = "You are a content moderation system for Facebook posts. Your task is to analyze the content of posts and determine if they violate community standards.\n" +
    "\n" +
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold">Cấu hình kiểm duyệt nội dung</h2></div>
          <button
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div><h3 className="font-medium text-blue-900">Tự động kiểm duyệt</h3><p
                  className="text-sm text-blue-700 mt-1">Tự động kiểm duyệt nội dung bài viết và bình luận</p></div>
              ...
              <div><h3 className="font-medium mb-3">Hành động tự động</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <button onClick={() => setHidePost(!hidePost)} className="text-gray-700">
                      {hidePost ? (
                        // Bật
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-blue-500" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        // Tắt
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-gray-400" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <rect width="20" height="12" x="2" y="6" rx="6" ry="6"></rect>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div><p className="font-medium">Tự động sửa nội dung</p><p className="text-sm text-gray-600 mt-1">Tự
                      động sửa các nội dung vi phạm nhẹ</p></div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div><p className="font-medium">Thông báo cho quản trị viên</p><p
                      className="text-sm text-gray-600 mt-1">Gửi email thông báo khi phát hiện vi phạm</p></div>
                  ...
                  <div className="ml-6">
                    <label className="block text-sm font-medium text-gray-700 mb-1">Email quản trị viên</label>
                    <input
                      type="email"
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between text-sm"><span
                    className="text-blue-600 font-medium">80%</span><span
                    className="text-blue-600 font-medium">85%</span><span
                    className="text-blue-600 font-medium">90%</span><span className="text-gray-600">95%</span><span
                    className="text-gray-600">100%</span></div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Prompt này sẽ được sử dụng để hướng dẫn AI kiểm duyệt nội
                  dung</p>
              </div>
            </div>
          </div>
        ...
        <div className="p-6 border-t border-gray-200 flex justify-end gap-3">
          <button className="px-4 py-2 text-gray-700 hover:text-gray-900 transition-colors" onClick={onClose}>Hủy</button>
          <button
