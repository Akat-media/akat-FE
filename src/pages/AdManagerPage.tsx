...
import {
  checkAdManagerAccess,
  getSystemAdAccounts,
  getRentals,
  createRental,
  type SystemAdAccount,
  type AdAccountRental,
} from '../lib/adManager';
    ...
    return (
      <div className="p-8 max-w-2xl mx-auto">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-red-700 mb-2">Không có quyền truy cập</h2>
          <p className="text-red-600">Tính năng này chỉ dành cho người dùng được ủy quyền.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Thuê và quản lý tài khoản quảng cáo Facebook từ hệ thống</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
                ...
                <div key={rental.id} className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium">{rental.account?.name || 'Unknown Account'}</h3>
                        <p className="text-sm text-gray-600">ID: {rental.account?.account_id}</p>
                      </div>
                    </div>
                    <div
              ...
              {rentals.length === 0 && (
                <div className="p-6 text-center text-gray-500">Chưa có lịch sử thuê tài khoản</div>
              )}
            </div>
          </div>
        </div>
