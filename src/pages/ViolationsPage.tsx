  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Danh sách các vi phạm nội dung được phát hiện bởi hệ thống</p>
      </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {violations.map((violation) => (
                  <tr key={violation.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm">{Math.round(violation.confidence * 100)}%</td>
